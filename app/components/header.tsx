      ...
      {width > 300 ? (
        ...
        <header className="z-[999] relative flex justify-center">
          <motion.div
            ...
            backdrop-blur-[0.5rem] sm:top-6 sm:h-[3.25rem] sm:w-[47rem] 
          ...
          <nav className="flex fixed mt-2 sm:mt-0 top-[0.15rem] left-1/2 h-5 sm:h-10 -translate-x-1/2
           sm:top-[1.7rem]  sm:py-0">
            ...
            <ul className={clsx("flex w-[18rem] flex-wrap items-center gap-y-1 justify-center text-[0.9rem] font-medium text-gray-500 sm:w-[initial] sm:flex-nowrap sm:gap-1")}>
              {Mlink.map((link) => (
                ...
                >
                  <Link
                    className={clsx(
                      "flex w-full  md:mx-1 font-bold items-center sm:justify-center    px-3 py-2 sm:px-5 sm:py-4 text-[12px] sm:text-[0.9rem] hover:text-gray-200 transition ",
                      {
                        "text-gray-200  ":
